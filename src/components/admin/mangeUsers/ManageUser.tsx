    ...
    return (
        <tr >
            ...
            <td className="px-6 py-4 whitespace-nowrap">
                ...
                <button className="px-4 py-2 font-medium text-white bg-red-600 rounded-md hover:bg-red-500 focus:outline-none focus:shadow-outline-red active:bg-red-600 transition duration-150 ease-in-out">Block</button>
            </td>
        </tr>
    )
}
