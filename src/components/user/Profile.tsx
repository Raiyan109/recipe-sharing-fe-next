                        ...
                        <div className="col-span-4 sm:col-span-3">
                            <div className="bg-white shadow rounded-lg p-6">
                                ...
                                <div className="flex flex-col">
                                    <span className="text-gray-700 uppercase font-bold tracking-wider mb-2">Membership status</span>
                                    {user.membership}
                                    {/* <ul>
                            ...
                            <div className="bg-white shadow rounded-lg p-6">
                                <div className="flex justify-between items-center">
                                    ...
                                    <div className="flex justify-center items-center">
                                        {/* w-fit */}
                                        <Link href='/user-dashboard/edit-profile' className="w-fit flex items-center justify-between gap-4 bg-primary hover:bg-primary/80 text-white font-medium py-1 px-3 rounded-full ease-in-out duration-100">
                                            Edit profile
                                        </Link>
                                    </div>
                                </div>
                                ...
                                <h2 className="text-xl font-bold mt-6 mb-4">Phone</h2>
                                <h3>{user.phone}</h3>
                            </div>
                        </div>
                    </div>
