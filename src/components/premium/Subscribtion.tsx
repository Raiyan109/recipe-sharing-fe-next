    ...
    return (
        <div>
            <div className="p-4 h-screen dark:bg-gray-800">
                <div
                    className="max-w-lg container mx-auto rounded-lg overflow-hidden lg:max-w-7xl lg:flex my-10 shadow-teal border-4 border-teal-400">
                        ...
                        <div className="mt-8">
                            ...
                            <ul className="pl-0 mt-8 lg:grid lg:grid-cols-2 lg:gap-x-8 lg:gap-y-5 space-y-5 lg:space-y-0">
                                <li className="flex items-start lg:col-span-1">
                                    <div className="flex-shrink-0"><svg className="h-5 w-5 text-teal-400 dark:text-teal-300"
